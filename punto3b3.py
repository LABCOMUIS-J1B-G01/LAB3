...
class punto3b3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, Ac=1):
        ...
        self.settings = Qt.QSettings("GNU Radio", "punto3b3")
...
def main(top_block_cls=punto3b3, options=None):
    if options is None:
    ...
    tb = top_block_cls(Ac=options.Ac)
