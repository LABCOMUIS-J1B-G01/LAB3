...
class Punto3b1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, Ac=1, ka=1):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Punto3b1")
...
def argument_parser():
    ...
    parser.add_argument(
        "--Ac", dest="Ac", type=eng_float, default="1.0",
        help="Set Amplitud Portadora [default=%(default)r]")
    parser.add_argument(
        "--ka", dest="ka", type=eng_float, default="1.0",
        help="Set Coeficiente ka [default=%(default)r]")
    return parser


def main(top_block_cls=Punto3b1, options=None):
    if options is None:
