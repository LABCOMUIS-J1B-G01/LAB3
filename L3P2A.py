...
class L3P2A(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "L3P2A")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 18368, A, 0, 0)
...
def main(top_block_cls=L3P2A, options=None):
