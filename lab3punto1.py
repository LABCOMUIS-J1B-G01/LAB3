...
class lab3punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, l_vect=1024):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab3punto1")
        ...
        self.connect((self.blocks_nlog10_ff_1, 0), (self.qtgui_number_sink_1, 0))
...
def argument_parser():
    ...
    parser.add_argument(
        ...
        help="Set longirud FFT [default=%(default)r]")
    return parser


def main(top_block_cls=lab3punto1, options=None):
    if options is None:
